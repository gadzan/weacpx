...
/**
 * Reap targets for orchestration worker sessions. These are acpx sessions weacpx
 ...
 * already in that set, and external coordinators have no weacpx-spawned owner.
 *
